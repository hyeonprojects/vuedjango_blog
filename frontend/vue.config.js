      ...
      new FileManagerPlugin({
        ...
        onEnd: {
          copy: [
            {
              source: "dist/static",
              destination: "../backend/blogsite/static/",
            },
            {
              source: "dist/favicon.ico",
              destination: "../backend/blogsite/static/img/",
            },
            {
              source: "dist/home.html",
              destination: "../backend/blogsite/templates/",
            },
            {
              source: "dist/post*.html",
              destination: "../backend/blogsite/templates/blog/",
            },
          ],
        },
      }),
